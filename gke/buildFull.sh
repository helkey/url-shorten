...
# Builds for initializing DBs
alias buildAddr='go build -o ReqAddr RequestAddr.go addr.go db.go dbAddr.go dbDrop.go dbUrl.go encode.go network.go param.go'
alias buildShort='go build -o ReqShort RequestShorten.go addr.go db.go dbAddr.go dbDROP.go dbUrl.go encode.go network.go param.go'
